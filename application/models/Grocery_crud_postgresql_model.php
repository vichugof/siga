 ...
 * LICENSE
 *
 * Extend of Grocery CRUD for postgresql    is released with dual licensing, using the GPL v3 (license-gpl3.txt) and the MIT license (license-mit.txt).
 ...
 *
 *
 * @package    	grocery CRUD for postgresql
 * @author     	Victor Gonzalez victor@sudo.com.co
 * @version    	1
 */
class Grocery_CRUD_postgresql_Model  extends Grocery_CRUD_Model  {
